  ...
  return (
    <>
      ...
      <CookieConsent
        ...
        buttonStyle={{ background:"#007BFF", color: "white", fontSize:"20px"}} // Adjusted for better visibility and contrast
        declineButtonStyle={{ background:"#cfcfcf", color: "black", fontSize: "20px"}}
        expires={150}
      >
